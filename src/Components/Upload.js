...
function Upload() {
  ...
  const handleUpload = async (e) => {
    ...
    if (title) {
      ...
      const res = await fetch("https://videouploader-api-production.up.railway.app/api/upload", {
        method: "POST",
        body: formData,
      });
    ...
    <UploadStyled>
      ...
      >
        ...
        <div className="input-control upload-con">
          ...
          <label htmlFor="subtitle" className="note-label">
            Note: You can upload subtitle in video player page
          </label>
